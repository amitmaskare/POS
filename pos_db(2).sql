...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 07, 2026 at 04:42 PM
...
INSERT INTO `returns` (`id`, `sale_id`, `invoice_no`, `return_type`, `refund_amount`, `reason`, `created_at`) VALUES
(1, 1, NULL, 'refund', '60.00', NULL, '2025-12-30 20:33:48'),
(2, 1, NULL, 'exchange', '0.00', NULL, '2025-12-30 20:35:16'),
(3, 1, NULL, 'exchange', '0.00', NULL, '2025-12-30 20:36:56'),
(4, 1, NULL, 'refund', '45.00', NULL, '2025-12-31 05:52:15'),
(5, 1, NULL, 'exchange', '0.00', NULL, '2025-12-31 06:02:29');
...
(1, 1, 1, 1, 'Soap', 'http://localhost:4000/public/uploads/product/soap.jpg', 1, 0, '60.00'),
(2, 2, 2, NULL, NULL, NULL, 1, 0, '30.00'),
(3, 3, 6, NULL, NULL, NULL, 1, 0, '30.00'),
(4, 4, 8, 142, 'Haldiram chips', NULL, 1, 0, '45.00'),
(5, 5, 7, NULL, NULL, NULL, 1, 0, '30.00');
...
(2, 'Cashier', '2025-10-16 03:29:36', '2025-10-16 10:29:36');
...
(5, 1, 1, '2025-10-19 16:01:25'),
(6, 1, 3, '2025-10-19 16:01:25'),
(7, 2, 1, '2025-10-19 16:01:54'),
(8, 2, 3, '2025-10-19 16:01:54'),
(9, 2, 1, '2025-10-19 16:02:11'),
(10, 2, 3, '2025-10-19 16:02:11');
...
CREATE TABLE `sales` (
  ...
  `tax` decimal(10,2) DEFAULT NULL,
  `total` decimal(10,2) DEFAULT NULL,
  `payment_type` enum('cash','card','upi') DEFAULT NULL,
...
(1, 'TXN-30-12-2025-0001', 1, '120.00', '0.86', '120.86', 'cash', 'partially_returned', '2025-12-30 20:32:01'),
...
(5, 1, 2, 'Water Bottle', 0, 1, '30.00', '30.00', 'http://localhost:4000/public/uploads/product/water.jpg', 0, 'no'),
