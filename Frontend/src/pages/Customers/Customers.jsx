...
import {customerList,getById,deleteItem} from "../../services/customerService"
...
fetchCustomerList()
  ...
  const fetchCustomerList =async()=>{
    ...
    try{
     ...
     // console.table(result.data); return false;
  ...
  return (
    <Box sx={{ minHeight: '100vh' }}>
     ...
     <ModalLayout open={open} onClose={() => setOpen(false)} onSaved={fetchCustomerList} editData={editData}/>
      {/* Stats */}
      <Box mt={2}>
        <Stats stats={stats} />
      </Box>
      ...
      {/* Customer List Table */}
      <TableLayout columns={columns} rows={customerRows}  extra={{ deleteItem: handleDelete, edit: handleEdit }}  actionButtons={[
            {
              label: "Filter",
              icon: <FilterListIcon />,
              variant: "outlined",
